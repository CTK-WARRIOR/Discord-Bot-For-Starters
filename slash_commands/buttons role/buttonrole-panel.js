...
module.exports = {
    ...
    .setDescription('This command is needed for the buttonrole-add and buttonrole-remove commands to work.'),
    /**
     * 
     * @param {Client} client 
